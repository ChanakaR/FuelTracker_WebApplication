...
class Vehicle extends AutoLoader{
    ...
    public function load_body(){
        ...
        if($this->role=="ADM"){
            $content .= '<button class="btn btn-danger" id="remove-vehicle" data-toggle="modal" onclick="removeVehicle()"><icon class="fa fa-minus-square-o"></icon> Remove</button>';
        }
...
$vehicle = new Vehicle();
$vehicle->load_header();
$vehicle->load_sidebar('vehicle');
$vehicle->load_body();
$vehicle->load_footer_tables();